...
(function(){
  ...
  function updateOverall(){
    ...
    if(ok===0) hint.textContent="Отмечено задач по всему плану. Начни с Недели 1.";
    else if(pct===100) hint.textContent="Весь план пройден. B1 достигнут — поздравляю.";
  ...
  document.getElementById("resetBtn").addEventListener("click",()=>{
    if(confirm("Сбросить весь прогресс по плану?")){
      done={}; persist();
